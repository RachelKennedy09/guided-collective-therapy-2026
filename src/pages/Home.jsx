...
export default function Contact() {
  return (
    <section className="home-links" aria-label="Contact">
      <div className="home-links__inner">
        <h2 className="home-links__title">Contact & referrals</h2>
        ...
        <div className="home-links__grid">
          <div className="home-card">
            ...
            <p style={{ marginTop: "0.75rem" }}>
              <strong>Please note:</strong> Please avoid sending urgent or
              highly detailed medical information by email. This form is for
              general inquiries only. We’ll follow up with next steps, including
              how to share referrals or records securely.
            </p>
